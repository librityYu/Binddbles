 ...
 *
 * Base class which extends [BindingComponentActivity] for activities that wish to bind content layout with [DataBindingUtil].
 ...
 */
abstract class BindingComponentActivity<T : ViewDataBinding> constructor(
